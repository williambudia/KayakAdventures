    ...
    <main className="min-h-screen bg-background">
      <div className="bg-primary py-20 px-4">
        <div className="container mx-auto max-w-7xl">
          <h1 className="text-white text-4xl md:text-5xl font-bold text-center font-montserrat">Galeria de Fotos</h1>
          <p className="text-primary-100 text-xl text-center mt-4 max-w-2xl mx-auto font-opensans">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-7xl">
          <GalleryClient images={galleryImages} categories={categories} />
        </div>
      </section>
          ...
          <div className="bg-background rounded-lg p-6 md:p-8 shadow-md">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-2/3">
                <h2 className="text-2xl md:text-3xl font-bold mb-4 text-primary font-montserrat">Faça Parte da Nossa Galeria</h2>
                <p className="text-gray-700 mb-6 font-opensans">
                ...
                <a 
                  ...
                  className="bg-primary hover:bg-primary-600 text-white font-medium py-2 px-6 rounded-full inline-flex items-center transition-colors duration-200"
                >
