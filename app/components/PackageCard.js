    ...
    >
      <div className="relative h-56 w-full overflow-hidden">
        ...
        {package_data.destaque && (
          <div className="absolute top-0 right-0 bg-accent text-primary-900 py-1 px-3 m-2 rounded-md text-xs font-bold shadow-md">
            Destaque
          </div>
        )}
      </div>
      ...
      <div className="p-6 flex-grow flex flex-col">
        <h3 className="text-xl font-bold text-primary mb-2 font-montserrat">{package_data.nome}</h3>
        <p className="text-gray-600 mb-4 flex-grow font-opensans">
